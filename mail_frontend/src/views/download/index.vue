...
const cards = [
  {
    ...
    url: 'https://zjkdongao.cn/downloads/mail-desktop_2.8.0_universal.dmg',
  ...
  },
  {
    ...
    url: 'https://zjkdongao.cn/downloads/mail-desktop_2.8.0_x64-setup.exe',
