      ...
      <div class="download-container">
        ...
        <div class="download-cards">
          ...
          <div v-for="card in sortedCards" :key="card.platform" class="download-card">
            ...
            <h2>{{ card.platform }}</h2>
            <p class="version">版本 {{ DESKTOP_RELEASE_VERSION }}</p>
            <a :href="card.url" class="download-btn"> 下载 {{ card.platform }} 版本 </a>
...
import { DESKTOP_DOWNLOAD_URLS, DESKTOP_RELEASE_VERSION } from '@/config/desktopRelease'
...
const cards = [
  {
    ...
    url: DESKTOP_DOWNLOAD_URLS.macos,
  ...
  },
  {
    ...
    url: DESKTOP_DOWNLOAD_URLS.windows,
